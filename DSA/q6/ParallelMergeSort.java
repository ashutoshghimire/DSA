...
public class ParallelMergeSort {
    ...
    /**
     * Performs parallel merge sort on an array.
     *
     * @param arr        The array to be sorted.
     * @param left       The left index of the array partition to be sorted.
     * @param right      The right index of the array partition to be sorted.
     * @param numThreads The number of threads available for parallel sorting.
     */
